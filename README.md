# 'Digital Receipt' Cloud Project | Web Application GUI (no database-incompleted)
This is my first Python web application (GUI for customers) for my project called "Digital Receipt". It uses the Flask framework and is based on a real-world scenario. However, the database is not set up yet, so the login function does not work.
